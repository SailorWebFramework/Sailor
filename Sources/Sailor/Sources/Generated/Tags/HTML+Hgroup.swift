...
extension HTML {
    /// The hgroup element represents a heading and related content, such as subheadings, an alternative title, or a tagline.
    @MainActor public struct Hgroup: @preconcurrency BodyElement {
        /// name of the html tag associated with this type
        @_spi(Private) public static var name: String { "hgroup" }
