...
extension HTML {
    /// The abbr element represents an abbreviation or acronym, optionally with its expansion given by the title attribute.
    @MainActor public struct Abbr: @preconcurrency BodyElement {
        /// name of the html tag associated with this type
        @_spi(Private) public static var name: String { "abbr" }
