...
//
//  Unit+TextDecorationThickness.swift
//  

extension Unit {
    public struct TextDecorationThickness: Equatable, CustomStringConvertible {
        var value: String
        ...
        ///from font.
        public static var `fromFont`: Self {
            return .init("from-font")
        }
